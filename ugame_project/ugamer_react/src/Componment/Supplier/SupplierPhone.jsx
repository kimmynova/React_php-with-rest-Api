            ...
            if (supid) {
                ...
                fetch(`http://localhost/ugame_project/ugamerphp/Supplier/supplier_phone_And_email.php/${supid}`)
                    ...
                    .then((data) => {
                        ...
                        console.log(data.employeephoneUpdate); // Log the 'employeephoneUpdate' property of the data object
                        
                        setTimeout(() => {
                           
                            setSupplierphone(data.employeephoneUpdate);
                            setIsLoading(false);
                        }, 1000);
                    })
                    .catch((err) => {
                    ...
                    <table className='w-full border-y'>
                        ...
                        <tbody className='text-center'>
                            {error ? (
                                ...
                                supplierphone.map((supplierphoneData, index) => (
                                    <tr
                                        ...
                                        <td className='flex pt-2 items-center justify-center'>{supplierphoneData.supid}</td>
                                        <td className='flex pt-2 items-center justify-center md:pr-5 sm:pr-5'>{supplierphoneData.phone}</td>
