        ...
        if (id) {
            ...
            fetch(`http://localhost/ugame_project/ugamerphp/Employee/EmployeePhneAndEmail.php/${id}`)
                ...
                .then((data) => {
                    ...
                    setTimeout(() => {
                        setEmployeeemail(data.employeeemailUpdate);
                        setIsLoading(false);
                    }, 1000);
                })
                .catch((err) => {
                ...
                <table className='w-full border-y'>
                    ...
                    <tbody className='text-center'>
                        {error ? (
                            ...
                            Employeeemail.map((employeeemailData, index) => (
                                <tr
                                    ...
                                    <td className='flex pt-2 items-center justify-center'>{employeeemailData.id}</td>
                                    <td className='flex pt-2 items-center justify-center md:pr-5 sm:pr-5'>{employeeemailData.email}</td>
